...
export default function Gyms() {
  ...
  return (
    <div className="relative flex min-h-[calc(100dvh-var(--app-header-height,5rem)-var(--app-bottom-nav-inset,5.5rem))] flex-1 flex-col md:min-h-[calc(100dvh-3rem)]">
      <GymDirectoryMap
        gyms={gyms}
        ...
        >
          <div className="pointer-events-auto mx-auto max-w-lg rounded-2xl border border-border/60 bg-card/95 p-4 shadow-lg backdrop-blur-sm">
            ...
            <div className="mt-3 flex gap-2">
              <Button className="flex-1" onClick={handleTrainHere}>
                Entrenar aquí
              </Button>
