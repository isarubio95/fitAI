    ...
    <GlobalWorkoutDrawerProvider>
      ...
      <div className="flex min-h-screen bg-background">
        ...
        <div className="flex-1 flex flex-col">
          ...
          <header className="fixed left-0 right-0 top-0 z-40 flex w-full items-center justify-between gap-3 bg-background px-4 py-2 dark:bg-zinc-950/40 dark:backdrop-blur-xl md:hidden">
