...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap transition-transform duration-150 active:scale-95 rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 disabled:shadow-none",
  {
    variants: {
      variant: {
        default: "h-11 rounded-xl border border-primary/70 bg-primary px-4 text-sm font-semibold leading-none text-primary-foreground shadow transition-all duration-200 hover:-translate-y-0.5 hover:bg-primary/92 hover:shadow-[0_12px_24px_rgba(0,0,0,0.2)] active:translate-y-[1px] active:scale-[0.99]",
        ...
        filter:
          "border border-border/20 bg-background hover:border-border/35 hover:bg-accent/55 hover:text-accent-foreground dark:hover:bg-accent/30",
        ...
        new: "min-h-9 !h-9 shrink-0 gap-1.5 rounded-full border border-primary/38 bg-primary/20 px-4 py-0 text-sm font-semibold text-foreground shadow-xs transition-[colors,box-shadow] hover:border-primary/48 hover:bg-primary/30 hover:text-foreground focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 [&_svg]:size-[1.1rem] dark:border-border/50 dark:bg-accent/50 dark:text-accent-foreground dark:shadow-sm dark:hover:border-border/50 dark:hover:bg-accent/90 dark:hover:text-accent-foreground",
      },
      size: {
