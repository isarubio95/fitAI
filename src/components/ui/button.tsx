...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap border-0 transition-transform duration-150 active:scale-95 rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 disabled:shadow-none",
  {
    variants: {
      variant: {
        default: "h-11 rounded-xl ring-1 ring-inset ring-primary/70 bg-primary px-4 text-sm font-semibold leading-none text-primary-foreground shadow transition-all duration-200 hover:-translate-y-0.5 hover:bg-primary/92 hover:shadow-[0_12px_24px_rgba(0,0,0,0.2)] active:translate-y-[1px] active:scale-[0.99]",
