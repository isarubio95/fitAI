  ...
  ),
  {
    variants: {
      side: {
        ...
        bottom:
          "inset-x-0 bottom-0 border-t data-[state=closed]:slide-out-to-bottom data-[state=open]:slide-in-from-bottom md:left-1/2 md:right-auto md:w-full md:max-w-2xl md:-translate-x-1/2",
