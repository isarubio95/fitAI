...
export const pillTabsListClass =
  "h-9 shrink-0 rounded-full bg-muted p-1 ring-1 ring-inset ring-surface-border dark:bg-background";
...
export const pillTabsIndicatorClass =
  "pointer-events-none absolute bottom-1 top-1 rounded-full bg-card shadow-elevated dark:bg-muted";
