-- Elimina todos los datos de un usuario en orden seguro (FKs).
-- Solo invocable con service_role (p. ej. desde Edge Function).
...
BEGIN
  ...
  DELETE FROM plan_generado_ia WHERE usuario_id = p_user_id;
