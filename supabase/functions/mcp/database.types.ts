  ...
  public: {
    Tables: {
      ...
      xp_evento: {
        ...
        Relationships: [
          {
            foreignKeyName: "xp_evento_actividad_id_fkey"
            columns: ["actividad_id"]
            isOneToOne: false
            referencedRelation: "actividad"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "xp_evento_cardio_sesion_id_fkey"
            columns: ["cardio_sesion_id"]
            isOneToOne: false
            referencedRelation: "cardio_sesion"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "xp_evento_usuario_id_fkey"
            columns: ["usuario_id"]
            isOneToOne: false
            referencedRelation: "perfil"
            referencedColumns: ["id"]
    ...
    Functions: {
      award_session_xp: {
        Args: { p_actividad_id?: string; p_cardio_sesion_id?: string }
        Returns: Json
      }
      delete_routine_cascade: {
        Args: { p_confirm_name: string; p_rutina_id: string }
        Returns: Json
      }
      delete_session_cascade: {
        Args: { p_confirm_title: string; p_kind: string; p_session_id: string }
        Returns: Json
      }
      ...
      get_exercise_set_history: {
        Args: {
          p_months?: number
          p_tipo_ejercicio_id?: string
          p_usuario_ejercicio_id?: string
        }
        Returns: {
          actividad_id: string
      ...
      gimnasio_haversine_km: {
        Args: { p_lat1: number; p_lat2: number; p_lng1: number; p_lng2: number }
        Returns: number
      }
      gimnasio_normalize_search: { Args: { p_value: string }; Returns: string }
      ...
      log_cardio_session: { Args: { p_payload: Json }; Returns: Json }
      log_strength_session: { Args: { p_payload: Json }; Returns: Json }
      recompute_profile_streak: { Args: never; Returns: Json }
      replace_session_exercises: {
        Args: { p_actividad_id: string; p_ejercicios: Json }
        Returns: Json
      }
      revoke_session_xp: {
        Args: { p_actividad_id?: string; p_cardio_sesion_id?: string }
      ...
      schedule_routine_dates: {
        Args: { p_fechas: string[]; p_rutina_id: string }
        Returns: Json
      }
      search_gimnasios: {
        Args: {
      ...
      summarize_series_plan: {
        Args: { p_fallback?: Json; p_plan: Json }
        Returns: Json
      }
      upsert_routine: {
        Args: {
